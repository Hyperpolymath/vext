...
image:https://img.shields.io/badge/deno-1.40+-blue.svg[Deno 1.40+]
image:https://img.shields.io/badge/license-MIT%20OR%20AGPL--3.0--or--later-green.svg[License]
image:https://img.shields.io/badge/RSR-Silver-silver.svg[RSR Compliance]
