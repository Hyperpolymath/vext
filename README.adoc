...
:experimental:
:url-github: https://github.com/hyperpolymath/vext
:url-gitlab: https://gitlab.com/hyperpolymath/vext
:url-bitbucket: https://bitbucket.org/hyperpolymath/vext
:url-codeberg: https://codeberg.org/hyperpolymath/vext

Vector extension library
...
vext is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
